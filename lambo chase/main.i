...
# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\8.2.0\\include\\stdarg.h" 1 3 4
# 40 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\8.2.0\\include\\stdarg.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 41 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\stdio.h" 2 3
# 61 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\stdio.h" 3
...
# 1 "instructions.h" 1
# 22 "instructions.h"
extern const unsigned short instructionsTiles[3424];
...
void goToMenu() {
    ...
    shadowOAM[24].attr0 = (0<<8) | (1<<14) | (0xFF & (160 / 2 + 16));
    shadowOAM[24].attr1 = (3<<14) | (0x1FF & (240 / 2 - 32));
    shadowOAM[24].attr2 = (((8)*32+(16))) | ((0)<<12);
...
void goToStart() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 6848 / 2);


    DMANow(3, instructionsMap, &((screenblock *)0x6000000)[20], 2048 / 2);


    (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((20)<<8) | (1<<7) | 0;
...
void goToLose() {
    ...
    (*(unsigned short *)0x4000000) = 0 | (1<<9) | 1;
